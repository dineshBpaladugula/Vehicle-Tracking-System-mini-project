...
body {
  background-image: url("images/mynew1.jpg");
...
<body background="images/mynew1.jpg">
    <img src="img/loader.gif" class="loader" alt="">

    <div class="container">
        <img src="img/icon.webp" class="logo" alt="">
        <div>
            <h2 align=center style="color:#FFFFFF">Partner Login</h2>
...
<form method="post" action="checkpartnerlogin">
...
<td colspan="2"><input type="submit" value="Login" class="button"></td>
        ...
        <center><a href="partnersignup" class="link" style="color:#FFFFFF">You didn't have account? Register here</a><br></center>
